class Game {
  ...
  constructor(canvasId) {
    ...
    this.shaurmacount = 1
    this.manument = document.getElementById("manument")
    this.komitas = document.getElementById("komitas")
    this.navigationDisplay = document.getElementById("navigation")
    this.levelPick = undefined
    this.levels = {
    ...
    this.background = new Background(this.ctx, this.levels.level2)
    ...
    this.navigate = new Navigation(this.ctx, 600, this.canvas.height - 250)
    ...
    this.polices = [
      ...
      new Police(this.ctx, this.mario.x + 2000, this.mario.y),
      new Police(this.ctx, this.mario.x + 3300, this.mario.y),
      new Police(this.ctx, this.mario.x + 5000, this.mario.y),
      new Police(this.ctx, this.mario.x + 6800, this.mario.y),
      new Police(this.ctx, this.mario.x + 8900, this.mario.y),
      new Police(this.ctx, this.mario.x + 10700, this.mario.y),
  ...
  start() {
    localStorage.setItem("level", "index2.html")
  ...
  move() {
    if (this.mario.x === this.mario.maxX && this.mario.isDie == false) {
      ...
      this.navigate.move(this.mario.x)
  ...
  onKeyEvent(event) {
    ...
    this.navigate.onKeyEvent(event)
  }
  ...
  checkCollisions() {
    ...
    if (this.mario.x >= this.navigate.x) {
      this.sounds.theme.pause()
      this.sounds.coin.pause()
