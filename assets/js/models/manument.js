class Game {
  ...
  constructor(canvasId) {
    ...
    this.background = new Background(this.ctx, this.levels.level3)

    this.bag = new Bag(this.ctx, 2000, this.canvas.height - 400)
    ...
    this.inteligent = [
      ...
      new Inteligent(this.ctx, this.mario.x + 8800, this.mario.y),
    ]
    ...
    this.alvards = [
      ...
      new Alvard(this.ctx, this.mario.x + 2100, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 2300, this.mario.y),
      ...
      new Alvard(this.ctx, this.mario.x + 19500, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 19900, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 20500, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 21200, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 21500, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 22900, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 23500, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 24200, this.mario.y),
    ]
    ...
    this.polices = [
      ...
      new Police(this.ctx, this.mario.x + 8722, this.mario.y),
      new Police(this.ctx, this.mario.x + 13422, this.mario.y),
      new Police(this.ctx, this.mario.x + 17234, this.mario.y),
    ]


    this.kims = [
      new Kim(this.ctx, this.mario.x + 5000, this.mario.y - 20),
      new Kim(this.ctx, this.mario.x + 12400, this.mario.y),
    ]


    this.papers = [
      new Paper(this.ctx, this.mario.x + 15000, this.mario.y),
    ]
  ...
  drawCoin(x, y, tmp) {
    if (tmp == 1) {
      ...
      this.coins.push(new Coin(this.ctx, x + (2 * 80) + 10, y - (30)))
      this.coins.push(new Coin(this.ctx, x + (3 * 80), y - (60)))
      this.coins.push(new Coin(this.ctx, x + (4 * 80), y - (90)))
      this.coins.push(new Coin(this.ctx, x + (5 * 80), y - (90)))
      this.coins.push(new Coin(this.ctx, x + (6 * 80), y - (60)))
      this.coins.push(new Coin(this.ctx, x + (7 * 80), y - (30)))
      this.coins.push(new Coin(this.ctx, x + (8 * 80), y - (50)))
      this.coins.push(new Coin(this.ctx, x + (9 * 80) + 10, y - (30)))
  ...
  start() {
    localStorage.setItem("level", "index3.html")
  ...
  checkCollisions() {
    ...
    if (this.drow) {
      ...
      this.drowGreade(2700, 1)
      this.drowGreade(3500, 2)
      this.drowGreade(4700, 1)
      this.drowGreade(5800, 2)
      this.drowGreade(7000, 1)
      this.drowGreade(9000, 2)
