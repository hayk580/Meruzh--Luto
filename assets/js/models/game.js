class Game {
  ...
  constructor(canvasId) {
    ...
    this.background = new Background(this.ctx, this.levels.level1)

    this.bag = new Bag(this.ctx, 2400, this.canvas.height - 500)
    ...
    this.alvards = [
      ...
      new Alvard(this.ctx, this.mario.x + 19000, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 19500, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 20200, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 21200, this.mario.y),
      new Alvard(this.ctx, this.mario.x + 22000, this.mario.y),
    ...
    this.papers = [
      new Paper(this.ctx, this.mario.x + 500, this.mario.y)
    ]
  ...
  drowGreade(x, tmp) {                                         //avelacnl block bag
    if (tmp == 1) {
  ...
  drowCOIN(x, tmp) {
    ...
    this.drawCoin(x + 840, this.canvas.height - 275, 2)
  ...
  start() {
    localStorage.setItem("level", "index.html")
  ...
  checkCollisions() {
    ...
    if (this.drow) {
      ...
      this.drowGreade(17600, 2)
      this.drowGreade(18100, 1)
      this.drowGreade(18600, 2)
      this.drowGreade(19100, 1)
      this.drowGreade(20500, 2)
      this.drowGreade(21600, 2)
      this.drowGreade(22100, 1)
      this.drowGreade(23300, 1)

      for (let i = 500; i < MASIV_WIDTH; i += 2000) {
        this.drowCOIN(i, 1);
      }
    }
...
for (let i = 0; i < this.mario.bulletsleft.length; i++) {
  ...
  this.inteligent = KodrvacIntel
    ...
    this.blocks.map(el => {
      ...
      if(this.mario.collidesWithUnderBlocks(el)) {
