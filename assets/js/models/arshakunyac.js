class Game {
  ...
  constructor(canvasId) {
    ...
    this.background = new Background(this.ctx, this.levels.level8)
    ...
    this.paperPoints = 0
    this.bag = new Bag(this.ctx, 8300, this.canvas.height - 600)
    ...
    this.kims = [
      ...
      new Kim(this.ctx, this.mario.x + 5000, this.mario.y),
      new Kim(this.ctx, this.mario.x + 10000, this.mario.y),
      new Kim(this.ctx, this.mario.x + 14000, this.mario.y),
    ]
  ...
  drowCOIN(x, tmp) {
    ...
    this.drawCoin(x + 1500, this.canvas.height - 300, 1)
    this.drawCoin(x + 3000, this.canvas.height - 300, 2)
  }
  ...
  start() {
    localStorage.setItem("level", "index8.html")
  ...
  this.inteligent = KodrvacIntel
    ...
    if(this.alvards.length == 0) {
        this.alvards.push(
            ...
            new Alvard(this.ctx, this.canvas.width + 1070, this.canvas.height - 120),
            )
    }
    ...
    if(this.polices.length == 0) {
        this.polices.push(
            new Police(this.ctx, this.canvas.width + 1000, this.canvas.height - 120)
            )
    }
    ...
    this.polices.forEach(police => {
        ...
        if(police.x < 0) {
            this.polices.shift()
            this.polices.push(new Police(this.ctx, this.canvas.width + 1300, this.canvas.height - 120))
        }
    })
