class Game {
  ...
  constructor(canvasId) {
    ...
    this.background = new Background(this.ctx, this.levels.level5)

    this.bag = new Bag(this.ctx, 300, this.canvas.height - 350)
    ...
    this.masiviBisetka = new Bisetka(this.ctx, HRAPARAK_WIDTH - 500, this.canvas.height - 200)
    this.inteligent = [
    ...
    this.kims = [
      new Kim(this.ctx, this.mario.x + 4020, this.mario.y - 20),
      new Kim(this.ctx, this.mario.x + 6300, this.mario.y),
    ]


    this.papers = [
      new Paper(this.ctx, this.mario.x + 10012, this.mario.y),
    ]
  ...
  drawCoin(x, y, tmp) {
    if (tmp == 1) {
      ...
      this.coins.push(new Coin(this.ctx, x + (9 * 80), y - (50)))
  ...
  start() {
    localStorage.setItem("level", "index5.html")
  ...
  checkCollisions() {
    ...
    if (this.drow) {
      ...
      this.drowGreade(8600, 2)
      this.drowGreade(9500, 1)
      this.drowGreade(11000, 1)
      this.drowGreade(12000, 2)
      this.drowGreade(12500, 1)
      this.drowGreade(13300, 2)
      this.drowGreade(14500, 1)
      for (let i = 500; i < 12500; i += 1781) {
        this.drowCOIN(i)
        //this.drowGreade(i,1)
      }
    }
