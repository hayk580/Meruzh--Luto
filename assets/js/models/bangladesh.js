  ...
  checkCollisions() {
    ...
    if(this.alvards.length == 0) {
        this.alvards.push(
            ...
            new Alvard(this.ctx, this.canvas.width + 700, this.canvas.height - 120),
    ...
    if(this.polices.length == 0) {
        this.polices.push(
            new Police(this.ctx, this.canvas.width + 950, this.canvas.height - 120),
            new Police(this.ctx, this.canvas.width + 1550, this.canvas.height - 120)
            )
    }
    ...
    this.polices.forEach(police => {
        ...
        if(police.x < 0) {
            this.polices.shift()
            this.polices.push(new Police(this.ctx, this.canvas.width + 950, this.canvas.height - 120))
