class   Game {
  ...
  constructor(canvasId) {
    ...
    this.inteligent = [
      ...
      new Inteligent(this.ctx, this.mario.x + 700, this.mario.y),
    ...
    this.polices = [
      ...
      new Police(this.ctx, this.mario.x + 11900, this.mario.y),
