 ...
 //   this.ctx.fillText(`ճշտի բալանս: ${sessionStorage.getItem('tuxtcount')}`, 30, 75)
  ...
  checkCollisions() {
    ...
    if(this.alvards.length == 0) {
        this.alvards.push(
            new Alvard(this.ctx, this.canvas.width + 240, this.canvas.height - 120),
            new Alvard(this.ctx, this.canvas.width + 490, this.canvas.height - 120),
            new Alvard(this.ctx, this.canvas.width + 970, this.canvas.height - 120),
            )
    }
    ...
    this.alvards.forEach(alvard => {
        ...
        if(alvard.x < 0) {
            this.alvards.shift()
            this.alvards.push(new Alvard(this.ctx, this.canvas.width + 300, this.canvas.height - 120))
