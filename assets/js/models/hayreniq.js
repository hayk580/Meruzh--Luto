class Game {
    ...
    constructor(canvasId) {
      ...
      this.kims = [
        ...
        new Kim(this.ctx, 4678, this.mario.y),
        new Kim(this.ctx, 4353, this.mario.y),
        new Kim(this.ctx, 6575 + 2400, this.mario.y),
        new Kim(this.ctx, 5675, this.mario.y),
      ]
  
  
      this.papers = [
        new Paper(this.ctx, this.mario.x + 7600, this.mario.y),
      ]
    ...
    checkCollisions() {
        ...
        if (this.drow) {
            this.drow = false
            this.drowGreade(500, 2)
            this.drowGreade(1100, 2)
            this.drowGreade(1900, 1)
            this.drowGreade(2500, 2)
            this.drowGreade(3150, 1)
            ...
            this.drowGreade(10000, 1)
            this.drowGreade(10500, 1)
            this.drowGreade(11500, 2)
            this.drowGreade(12900, 1)
            this.drowGreade(13700, 1)
            this.drowGreade(14400, 2)
            this.drowGreade(15100, 1)
            this.drowGreade(15800, 1)
            this.drowGreade(16400, 2)
            this.drowGreade(17900, 2)
            this.drowGreade(18500, 2)
            this.drowGreade(19000, 2)
            for (let i = 500; i < 1000000; i += 800) {
              this.drowCOIN(i,1);
            }
          }
